class Table
    ...
    #     debugger
    #     p1_hand = hand_to_str(self.players[0])
    #     p2_hand = hand_to_str(self.players[1])
    #     # p2_hand_str = (self.players[1].hand.cards + self.cards).join(" ")
    #     # p2_hand = PokerHand.new(p2_hand_str)
    #     if p1_hand > p2_hand
    #         puts "#{self.players[0].seat} wins!"
    #     elsif p1_hand < p2_hand
    #         puts "#{self.players[1].seat} wins!"
    #     else
    #         puts "Tie game!"
    #     end
    # end
